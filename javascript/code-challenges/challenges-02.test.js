...
const raisedToTheThird = (arr) => {
  // Solution code here...
  let powArr=[];
  arr.forEach(element => powArr.push(Math.pow(element, 3)));
  return powArr;
};
...
const addOne = (arr) => {
  // Solution code here...
  let incrementedArr=arr.map(element=>element+1);
...
const forLoopTwoToThe = (arr) => {
  ...
  for (let i=0; i<arr.length; i++){
    twoPowers.push(Math.pow(2,arr[i]));
  }
  return twoPowers;
};
...
const forEachTwoToThe = (arr) => {
  // Solution code here...
  let twoPowers=[];
  arr.forEach(element=>twoPowers.push(Math.pow(2,element)));
  return twoPowers;
};
...
const mapTwoToThe = (arr) => {
  // Solution code here...
  let twoPowers=arr.map(int=> Math.pow(2,int))
return twoPowers;
};
